...
vim.keymap.set('n', '<leader>do', function() require('dapui').open() end, {desc = 'Debug: Open'})
vim.keymap.set('n', '<leader>dc', function() require('dapui').close() end, {desc = 'Debug: Close'})
vim.keymap.set('n', '<leader>dr', function() require('dap').repl.toggle() end, {desc = 'Debug: Repl Toggle'})
